    ...
    <form action="{{ route('penilais.update', $penilai) }}" method="POST" class="p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="md:col-span-2 mt-4 pt-4 border-t border-slate-100">
                <label class="block text-sm font-bold text-slate-700 mb-1">Pilih Guru yang Dapat Dinilai oleh Asesor Ini <span class="text-xs font-normal text-slate-500">(Bisa ditambah atau dikurangi)</span></label>
...
@php
    $oldGuruIds = old('guru_ids', $assignedGuruIds);
