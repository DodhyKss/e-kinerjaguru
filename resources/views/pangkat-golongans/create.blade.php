...
@extends('layouts.app')
@section('title', 'Tambah Pangkat / Golongan')
...
<div class="max-w-2xl bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
    <div class="px-8 py-6 border-b border-slate-100 bg-slate-50">
        <h2 class="text-xl font-bold text-slate-800">Form Tambah Pangkat / Golongan</h2>
    </div>
    
    <div class="p-8">
        <form action="{{ route('pangkat-golongans.store') }}" method="POST">
            @csrf
