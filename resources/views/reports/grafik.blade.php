...
<div class="mb-6">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        <div class="flex items-center gap-3 mb-4">
            ...
            <h3 class="text-base font-bold text-slate-900">Filter Sekolah</h3>
        </div>
...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 mb-8">
    <h3 class="text-base font-bold text-slate-900 mb-4 flex items-center">
        ...
        Rata-rata Skor per Dimensi Penilaian (Periode Aktif)
    </h3>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const dimensionData = @json($chartData['dimensions']);
    ...
    new Chart(ctxDimension, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Rata-rata Skor (Skala 4.0)',
